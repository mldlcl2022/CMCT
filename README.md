...
This is an official implementation of our **MICCAI 2026** paper ([Cross-Modal Concept Transfer: From ECG Signals to Images for Explainable Disease Prediction](TBD))
